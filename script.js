  ...
  this.Populate = function() {
    ...
    if (this.mhs.length > 0) {
      for (i = 0; i < this.mhs.length; i++) {
        ...
        data += '<td><button class="btn-info" onclick="app.Edit(' + i + ')"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>Edit</button> <button class="btn-danger" onclick="app.Delete(' + i + ')"><span class="glyphicon glyphicon-erase" aria-hidden="true"></span> Delete</button></td>';
        data += '</tr>';
      }
